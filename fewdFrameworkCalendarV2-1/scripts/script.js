...
function getActiveDay(date) {
  ...
  addEventSubmit.addEventListener("click", () => {
    ...
    if (
        ...
        alert("Please fill all fields. There is a 60 character for Event Name. Enter valid 4 digit time in 24-Hour Time Format for Time From and Time To. Enter only numbers for times.");
        return;
